...
export const Faq = () => {
  ...
  return (
    <section className="my-10 p-7 border rounded text-black shadow-sm">
      <h1 className="text-2xl text-center font-semibold text-black mb-3 underline underline-offset-8">Question in mind?</h1>
